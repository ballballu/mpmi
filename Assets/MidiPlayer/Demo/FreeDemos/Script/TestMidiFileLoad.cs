    ...
    public class TestMidiFileLoad : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            if (MidiLoader != null)
            {
                ...
                if (GUILayout.Button("Load MIDI from MidiDB", GUILayout.Width(160)))
                ...
                GUILayout.Label("The simplest MIDI file loader with index defined by code:", GUILayout.Width(380));
                if (GUILayout.Button(new GUIContent("Load MIDI File index 10", ""), GUILayout.Width(160)))
                {
