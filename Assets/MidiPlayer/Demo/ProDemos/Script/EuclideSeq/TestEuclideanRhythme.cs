    ...
    public class TestEuclideanRhythme : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (midiFilePlayer == null)
                Debug.LogWarning("Can't find a midiFilePlayer in the Project Hierarchy. No music will be played");
        ...
        private void Update()
        {
            ...
            //   lock (this)
            {
                ...
                // Usefull to hide 3D object as hit (Sphere) and arrow. The scrolview position is left bottom (0,0),
